			...
			for (var n = 0; n < e; n++) {
				...
				if (m.performUpdateIfNecessary(r, t.reconcileTransaction, y), i && console.timeEnd(i), o)
					for (var c = 0;
						...
						c++) t.callbackQueue.enqueue(o[c], r.getPublicInstance())
			}
		}
					...
					this.recognizer = new window.webkitSpeechRecognition, this.recognizer.lang = "en-US", this.recognizer.interimResults = !0, this.recognizer.onaudiostart = function() {
						...
						if (null != e.results && 0 != e.length) {
							...
							if (!0 === n.isFinal && null != t.onFinalResult) t.onFinalResult(n[0].transcript);
								...
								for (var r = "", o = 0; o < e.results.length;
									++o) r += e.results[o][0].transcript;
 ...
 */
		...
		function r(t) {
			...
			var r = t.Map;
			if (r)
				for (var o = Object.getOwnPropertyNames(r.prototype), i = 0; i < o.length;
					++i) {
					var s = o[i];
		...
		function r(t) {
			for (var e;
				(e = t._renderedNodeType) === o.COMPOSITE;
		...
		e.defaultStrings = r["en-us"], e.strings = function(t) {
			return t.startsWith("da") ? t = "da-dk" : t.startsWith("de") ? t = "de-de" : t.startsWith("no") || t.startsWith("nb") || t.startsWith("nn") ? t = "nb-no" : t.startsWith("pl") ? t = "pl-pl" : t.startsWith("ru") ? t = "ru-ru" : t.startsWith("nl") ? t = "nl-nl" : t.startsWith("lv") ? t = "lv-lv" : t.startsWith("pt") ? t = "pt-br" : t.startsWith("fr") ? t = "fr-fr" : t.startsWith("es") ? t = "es-es" : t.startsWith("el") ? t = "el-gr" : t.startsWith("it") ? t = "it-it" : "zh-hant" === t || "zh-hk" === t || "zh-mo" === t || "zh-tw" === t ? t = "zh-hant" : t.startsWith("zh") ? t = "zh-hans" : t.startsWith("cs") ? t = "cs-cz" : t.startsWith("ko") ? t = "ko-kr" : t.startsWith("ja") ? t = "ja-jp" : t in r == !1 && (t = "es-es"), r[t]
		}
	}, function(t, e, n) {
		"use strict";
